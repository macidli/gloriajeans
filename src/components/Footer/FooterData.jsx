  ...
  links: [
    {
      ...
      links: [
        ...
        { name: "Shop Coffee Online", to: "/shop" },
        { name: "In-store Menu", to: "/menu" },
        { name: "Nutritional Information", to: "/nutrition" },
        { name: "Sustainability", to: "/sustainability" },
        { name: "Own A Franchise", to: "/franchise" },
        { name: "Online Ordering", to: "/order" },
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Do Not Sell or Share My Info", to: "/donotsell" },
      ],
    },
  ],
