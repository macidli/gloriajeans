...
function Upper() {
  ...
  return (
    <div className="hidden bg-black h-[46px] w-full md:flex justify-end items-center text-white relative z-[300]">
      <div className="hidden lg:flex gap-[35px] pr-[20px] relative">
        <a href="https://www.gloriajeans.com/pages/loyalty">
        ...
        >
          ...
          {showDropdown && (
            <div className="absolute top-[10px] right-0 mt-2 bg-black font-Montserrat text-white p-4 w-[650px] max-h-[500px] grid grid-cols-3 rounded shadow-lg z-[300] overflow-auto">
